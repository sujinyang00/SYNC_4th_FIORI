		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Exam",
									"targetURL": "#practice1700-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practice1700-display": {
								"semanticObject": "practice1700",
								"action": "display",
								"description": "Practice for Fiori Exam",
								"title": "Fiori Exam",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practice1700",
									"url": sap.ui.require.toUrl("practice1700")
								}
							}
						}
					}
