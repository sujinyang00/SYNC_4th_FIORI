sap.ui.define([
    ...
    function (Controller, JSONModel) {
        ...
        return Controller.extend("practice1700.controller.Main", {
            ...
            onCal: function() {
                var sInput1 = Number(this.byId("idInput1").getValue());
                var sInput2 = Number(this.byId("idInput2").getValue());
                var result = 0;
                
                var oper_key = this.byId("idCombobox").getSelectedItem().getKey(); //plus
                var oper_val = this.byId("idCombobox").getSelectedItem().getText(); //+
