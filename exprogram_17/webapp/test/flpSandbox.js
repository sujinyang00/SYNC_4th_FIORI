		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (17)",
									"targetURL": "#examexprogram17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram17-display": {
								"semanticObject": "examexprogram17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram17",
									"url": sap.ui.require.toUrl("exam/exprogram17")
								}
							}
						}
					}
